...
function map(){
    ...
    d3.csv("data/colors.csv", function(error, data){
        temp = data[0];
        var tmpIndex = 0;
	...
	d3.csv("data/elections-unicode-ordered.csv", function(error, data) {
        self.data2 = data;
    ...
    d3.json("data/swe_mun.topojson", function(error, country) {
